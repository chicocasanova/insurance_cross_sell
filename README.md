...
- Python
- Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn, GridSearchCV
- XGBoost
- Flask
- Render
- Google Script
...
Durante o processo de modelagem, foram criadas e transformadas variáveis para melhorar o poder preditivo do modelo, como:

- **vehicle_age_encoded:** transformação ordinal da idade do veículo.
- **region_code_freq:** codificação de frequência para representar a popularidade de uma região.
- **interaction_features:** interações entre variáveis de risco e histórico de seguro.

Essas transformações foram aplicadas dentro do pipeline do Scikit-learn para garantir consistência durante o deploy.
...
O **XGBoost** apresentou o melhor equilíbrio entre *Precision at k* e *Recall at k*, além de melhor performance em dados desbalanceados.
...
<img src="results/real_case_scenario.jpg" alt="Real Case Scenario" width="1000"/>  
